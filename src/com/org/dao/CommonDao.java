...
public class CommonDao extends BaseDao {
     ...
     * @throws SvcException
     */
    public JSONObject querySingle(String sql, Map<Integer, Object> params, List<String> secretColumn) throws SvcException {
        JSONObject jo = null;
        try {
    ...
    public synchronized void update(String sql, Map<Integer, Object> params) throws SQLException {
        java.sql.Connection conn = getConnection();
