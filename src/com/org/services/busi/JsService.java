...
public class JsService {
    ...
    public void save(String userId, String browserName, String browserVersion, String operateName, String operateDateTime, String currentPage,
        ...
        try {
            commonDao.addSingle(this.sql_insert, params);
